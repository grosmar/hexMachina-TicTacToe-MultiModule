...
var hex_control_Responder = function(completable) {
	this._completable = completable;
};
$hxClasses["hex.control.Responder"] = hex_control_Responder;
hex_control_Responder.__name__ = ["hex","control","Responder"];
hex_control_Responder.__interfaces__ = [hex_control_ICompletable];
hex_control_Responder.prototype = {
	complete: function(result) {
		throw new js__$Boot_HaxeError(new hex_error_VirtualMethodException(Std.string(this) + ".complete must be overridden",{ fileName : "Responder.hx", lineNumber : 21, className : "hex.control.Responder", methodName : "complete"}));
	}
	,fail: function(error) {
		throw new js__$Boot_HaxeError(new hex_error_VirtualMethodException(Std.string(this) + ".fail must be overridden",{ fileName : "Responder.hx", lineNumber : 26, className : "hex.control.Responder", methodName : "fail"}));
	}
	,onComplete: function(callback) {
	...
	,__class__: hex_control_Responder
};
...
var hex_model_BasicModel_$tictactoe_$module_$board_$model_$_$BoardModel_$BoardModelDispatcher_$tictactoe_$module_$board_$model_$IBoardModelListener = function() {
	this.dispatcher = new tictactoe_module_board_model__$BoardModel_BoardModelDispatcher();
};
$hxClasses["hex.model.BasicModel_tictactoe_module_board_model__BoardModel_BoardModelDispatcher_tictactoe_module_board_model_IBoardModelListener"] = hex_model_BasicModel_$tictactoe_$module_$board_$model_$_$BoardModel_$BoardModelDispatcher_$tictactoe_$module_$board_$model_$IBoardModelListener;
hex_model_BasicModel_$tictactoe_$module_$board_$model_$_$BoardModel_$BoardModelDispatcher_$tictactoe_$module_$board_$model_$IBoardModelListener.__name__ = ["hex","model","BasicModel_tictactoe_module_board_model__BoardModel_BoardModelDispatcher_tictactoe_module_board_model_IBoardModelListener"];
hex_model_BasicModel_$tictactoe_$module_$board_$model_$_$BoardModel_$BoardModelDispatcher_$tictactoe_$module_$board_$model_$IBoardModelListener.prototype = {
	addListener: function(listener) {
	...
	,__class__: hex_model_BasicModel_$tictactoe_$module_$board_$model_$_$BoardModel_$BoardModelDispatcher_$tictactoe_$module_$board_$model_$IBoardModelListener
};
...
var hex_model_BasicModel_$tictactoe_$module_$player_$ai_$model_$_$AIPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$ai_$model_$IAIPlayerModelListener = function() {
	this.dispatcher = new tictactoe_module_player_ai_model__$AIPlayerModel_GameModelDispatcher();
};
$hxClasses["hex.model.BasicModel_tictactoe_module_player_ai_model__AIPlayerModel_GameModelDispatcher_tictactoe_module_player_ai_model_IAIPlayerModelListener"] = hex_model_BasicModel_$tictactoe_$module_$player_$ai_$model_$_$AIPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$ai_$model_$IAIPlayerModelListener;
hex_model_BasicModel_$tictactoe_$module_$player_$ai_$model_$_$AIPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$ai_$model_$IAIPlayerModelListener.__name__ = ["hex","model","BasicModel_tictactoe_module_player_ai_model__AIPlayerModel_GameModelDispatcher_tictactoe_module_player_ai_model_IAIPlayerModelListener"];
hex_model_BasicModel_$tictactoe_$module_$player_$ai_$model_$_$AIPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$ai_$model_$IAIPlayerModelListener.prototype = {
	addListener: function(listener) {
		this.dispatcher.addListener(listener);
	}
	,removeListener: function(listener) {
	...
	,__class__: hex_model_BasicModel_$tictactoe_$module_$player_$ai_$model_$_$AIPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$ai_$model_$IAIPlayerModelListener
};
var hex_model_BasicModel_$tictactoe_$module_$player_$user_$model_$_$UserPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$user_$model_$IUserPlayerModelListener = function() {
	this.dispatcher = new tictactoe_module_player_user_model__$UserPlayerModel_GameModelDispatcher();
};
$hxClasses["hex.model.BasicModel_tictactoe_module_player_user_model__UserPlayerModel_GameModelDispatcher_tictactoe_module_player_user_model_IUserPlayerModelListener"] = hex_model_BasicModel_$tictactoe_$module_$player_$user_$model_$_$UserPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$user_$model_$IUserPlayerModelListener;
hex_model_BasicModel_$tictactoe_$module_$player_$user_$model_$_$UserPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$user_$model_$IUserPlayerModelListener.__name__ = ["hex","model","BasicModel_tictactoe_module_player_user_model__UserPlayerModel_GameModelDispatcher_tictactoe_module_player_user_model_IUserPlayerModelListener"];
hex_model_BasicModel_$tictactoe_$module_$player_$user_$model_$_$UserPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$user_$model_$IUserPlayerModelListener.prototype = {
	addListener: function(listener) {
		this.dispatcher.addListener(listener);
	}
	,removeListener: function(listener) {
	...
	,__class__: hex_model_BasicModel_$tictactoe_$module_$player_$user_$model_$_$UserPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$user_$model_$IUserPlayerModelListener
};
...
var hex_model_IModelRO_$tictactoe_$module_$board_$model_$IBoardModelListener = function() { };
$hxClasses["hex.model.IModelRO_tictactoe_module_board_model_IBoardModelListener"] = hex_model_IModelRO_$tictactoe_$module_$board_$model_$IBoardModelListener;
hex_model_IModelRO_$tictactoe_$module_$board_$model_$IBoardModelListener.__name__ = ["hex","model","IModelRO_tictactoe_module_board_model_IBoardModelListener"];
hex_model_IModelRO_$tictactoe_$module_$board_$model_$IBoardModelListener.prototype = {
	__class__: hex_model_IModelRO_$tictactoe_$module_$board_$model_$IBoardModelListener
};
...
var hex_model_IModelRO_$tictactoe_$module_$player_$ai_$model_$IAIPlayerModelListener = function() { };
$hxClasses["hex.model.IModelRO_tictactoe_module_player_ai_model_IAIPlayerModelListener"] = hex_model_IModelRO_$tictactoe_$module_$player_$ai_$model_$IAIPlayerModelListener;
hex_model_IModelRO_$tictactoe_$module_$player_$ai_$model_$IAIPlayerModelListener.__name__ = ["hex","model","IModelRO_tictactoe_module_player_ai_model_IAIPlayerModelListener"];
hex_model_IModelRO_$tictactoe_$module_$player_$ai_$model_$IAIPlayerModelListener.prototype = {
	__class__: hex_model_IModelRO_$tictactoe_$module_$player_$ai_$model_$IAIPlayerModelListener
};
var hex_model_IModelRO_$tictactoe_$module_$player_$user_$model_$IUserPlayerModelListener = function() { };
$hxClasses["hex.model.IModelRO_tictactoe_module_player_user_model_IUserPlayerModelListener"] = hex_model_IModelRO_$tictactoe_$module_$player_$user_$model_$IUserPlayerModelListener;
hex_model_IModelRO_$tictactoe_$module_$player_$user_$model_$IUserPlayerModelListener.__name__ = ["hex","model","IModelRO_tictactoe_module_player_user_model_IUserPlayerModelListener"];
hex_model_IModelRO_$tictactoe_$module_$player_$user_$model_$IUserPlayerModelListener.prototype = {
	__class__: hex_model_IModelRO_$tictactoe_$module_$player_$user_$model_$IUserPlayerModelListener
};
...
var tictactoe_module_board_model_IBoardModelListener = function() { };
$hxClasses["tictactoe.module.board.model.IBoardModelListener"] = tictactoe_module_board_model_IBoardModelListener;
tictactoe_module_board_model_IBoardModelListener.__name__ = ["tictactoe","module","board","model","IBoardModelListener"];
tictactoe_module_board_model_IBoardModelListener.prototype = {
	__class__: tictactoe_module_board_model_IBoardModelListener
};
var tictactoe_module_board_view_IBoardView = function() { };
$hxClasses["tictactoe.module.board.view.IBoardView"] = tictactoe_module_board_view_IBoardView;
tictactoe_module_board_view_IBoardView.__name__ = ["tictactoe","module","board","view","IBoardView"];
...
$hxClasses["js.tictactoe.view.board.BoardView"] = js_tictactoe_view_board_BoardView;
js_tictactoe_view_board_BoardView.__name__ = ["js","tictactoe","view","board","BoardView"];
js_tictactoe_view_board_BoardView.__interfaces__ = [tictactoe_module_board_model_IBoardModelListener,tictactoe_module_board_view_IBoardView];
js_tictactoe_view_board_BoardView.__super__ = hex_view_BasicView;
js_tictactoe_view_board_BoardView.prototype = $extend(hex_view_BasicView.prototype,{
	init: function() {
	...
	,__class__: js_tictactoe_view_board_BoardView
});
...
var tictactoe_module_player_user_view_IUserPlayerView = function() { };
$hxClasses["tictactoe.module.player.user.view.IUserPlayerView"] = tictactoe_module_player_user_view_IUserPlayerView;
tictactoe_module_player_user_view_IUserPlayerView.__name__ = ["tictactoe","module","player","user","view","IUserPlayerView"];
tictactoe_module_player_user_view_IUserPlayerView.__interfaces__ = [hex_view_IView];
tictactoe_module_player_user_view_IUserPlayerView.prototype = {
	__class__: tictactoe_module_player_user_view_IUserPlayerView
};
var js_tictactoe_view_player_user_UserPlayerView = function(board) {
	this.board = board;
};
$hxClasses["js.tictactoe.view.player.user.UserPlayerView"] = js_tictactoe_view_player_user_UserPlayerView;
js_tictactoe_view_player_user_UserPlayerView.__name__ = ["js","tictactoe","view","player","user","UserPlayerView"];
js_tictactoe_view_player_user_UserPlayerView.__interfaces__ = [tictactoe_module_player_user_view_IUserPlayerView];
js_tictactoe_view_player_user_UserPlayerView.prototype = {
	getChoice: function() {
		this.addListeners();
	...
	,__class__: js_tictactoe_view_player_user_UserPlayerView
};
var tictactoe_TicTacToe = function() {
	var applicationAssembler = new hex_ioc_assembler_ApplicationAssembler();
	var applicationContext = applicationAssembler.getApplicationContext("ticTacToe");
	...
	var boardSize = new hex_structures_Size(3.,3.);
	coreFactory.register("boardSize",boardSize);
	var boardViewDiv = window.document.querySelector(".tic-tac-toe-table");
	coreFactory.register("boardViewDiv",boardViewDiv);
	var boardView = new js_tictactoe_view_board_BoardView(boardViewDiv);
	coreFactory.register("boardView",boardView);
	hex_domain_DomainExpert.getInstance().registerDomain(hex_domain_DomainUtil.getDomain("boardModule",hex_domain_Domain));
	hex_metadata_AnnotationProvider.registerToParentDomain(hex_domain_DomainUtil.getDomain("boardModule",hex_domain_Domain),hex_domain_DomainUtil.getDomain("ticTacToe",hex_domain_Domain));
	var boardModule = new tictactoe_module_board_BoardModule(boardSize,3,boardView);
	coreFactory.register("boardModule",boardModule);
	var userPlayerView = new js_tictactoe_view_player_user_UserPlayerView(boardViewDiv);
	coreFactory.register("userPlayerView",userPlayerView);
	hex_domain_DomainExpert.getInstance().registerDomain(hex_domain_DomainUtil.getDomain("userPlayer3",hex_domain_Domain));
	hex_metadata_AnnotationProvider.registerToParentDomain(hex_domain_DomainUtil.getDomain("userPlayer3",hex_domain_Domain),hex_domain_DomainUtil.getDomain("ticTacToe",hex_domain_Domain));
	var userPlayer3 = new tictactoe_module_player_user_UserPlayerModule(userPlayerView,"r",boardModule);
	coreFactory.register("userPlayer3",userPlayer3);
	var activePlayerIndicatorDiv = window.document.querySelector(".player-list");
	coreFactory.register("activePlayerIndicatorDiv",activePlayerIndicatorDiv);
	var activePlayerIndicatorView = new js_tictactoe_view_game_ActivePlayerIndicatorView(activePlayerIndicatorDiv);
	coreFactory.register("activePlayerIndicatorView",activePlayerIndicatorView);
	hex_domain_DomainExpert.getInstance().registerDomain(hex_domain_DomainUtil.getDomain("aiPlayer1",hex_domain_Domain));
	hex_metadata_AnnotationProvider.registerToParentDomain(hex_domain_DomainUtil.getDomain("aiPlayer1",hex_domain_Domain),hex_domain_DomainUtil.getDomain("ticTacToe",hex_domain_Domain));
	var aiPlayer1 = new tictactoe_module_player_ai_AIPlayerModule("o",boardModule);
	coreFactory.register("aiPlayer1",aiPlayer1);
	hex_domain_DomainExpert.getInstance().registerDomain(hex_domain_DomainUtil.getDomain("userPlayer1",hex_domain_Domain));
	hex_metadata_AnnotationProvider.registerToParentDomain(hex_domain_DomainUtil.getDomain("userPlayer1",hex_domain_Domain),hex_domain_DomainUtil.getDomain("ticTacToe",hex_domain_Domain));
	var userPlayer1 = new tictactoe_module_player_user_UserPlayerModule(userPlayerView,"x",boardModule);
	coreFactory.register("userPlayer1",userPlayer1);
	hex_domain_DomainExpert.getInstance().registerDomain(hex_domain_DomainUtil.getDomain("gameModule",hex_domain_Domain));
	hex_metadata_AnnotationProvider.registerToParentDomain(hex_domain_DomainUtil.getDomain("gameModule",hex_domain_Domain),hex_domain_DomainUtil.getDomain("ticTacToe",hex_domain_Domain));
	var gameModule = new tictactoe_module_game_GameModule(boardModule,activePlayerIndicatorView,userPlayer1,aiPlayer1);
	coreFactory.register("gameModule",gameModule);
	hex_domain_DomainExpert.getInstance().registerDomain(hex_domain_DomainUtil.getDomain("userPlayer2",hex_domain_Domain));
	hex_metadata_AnnotationProvider.registerToParentDomain(hex_domain_DomainUtil.getDomain("userPlayer2",hex_domain_Domain),hex_domain_DomainUtil.getDomain("ticTacToe",hex_domain_Domain));
	var userPlayer2 = new tictactoe_module_player_user_UserPlayerModule(userPlayerView,"o",boardModule);
	coreFactory.register("userPlayer2",userPlayer2);
	...
	userPlayer3.initialize();
	gameModule.initialize();
	userPlayer1.initialize();
	boardModule.initialize();
	userPlayer2.initialize();
	aiPlayer1.initialize();
...
var tictactoe_api_IBoard = function() { };
$hxClasses["tictactoe.api.IBoard"] = tictactoe_api_IBoard;
tictactoe_api_IBoard.__name__ = ["tictactoe","api","IBoard"];
tictactoe_api_IBoard.prototype = {
	__class__: tictactoe_api_IBoard
};
var tictactoe_api_IPlayer = function() { };
$hxClasses["tictactoe.api.IPlayer"] = tictactoe_api_IPlayer;
tictactoe_api_IPlayer.__name__ = ["tictactoe","api","IPlayer"];
tictactoe_api_IPlayer.prototype = {
	__class__: tictactoe_api_IPlayer
};
var tictactoe_module_board_BoardModule = function(board,successLineCount,boardView) {
	hex_module_Module.call(this);
	this._addStatelessConfigClasses([tictactoe_module_board__$BoardModule_BoardModuleConfig]);
	this._injector.mapToValue(tictactoe_module_board_view_IBoardView,boardView);
	this._injector.injectInto(boardView);
	this._get(tictactoe_module_board_controller_IBoardController).setBoard(board,successLineCount);
};
$hxClasses["tictactoe.module.board.BoardModule"] = tictactoe_module_board_BoardModule;
tictactoe_module_board_BoardModule.__name__ = ["tictactoe","module","board","BoardModule"];
tictactoe_module_board_BoardModule.__interfaces__ = [tictactoe_api_IBoard];
tictactoe_module_board_BoardModule.__super__ = hex_module_Module;
tictactoe_module_board_BoardModule.prototype = $extend(hex_module_Module.prototype,{
	setWinnerLine: function(line) {
		this._get(tictactoe_module_board_controller_IBoardController).setWinnerLine(line);
	}
	,setBoardPoint: function(point,sign) {
		this._get(tictactoe_module_board_controller_IBoardController).setBoardPoint(new hex_structures_Size(point.x,point.y),sign);
	}
	,getBoardPoint: function(point) {
		return this._get(tictactoe_module_board_controller_IBoardController).getBoardPoint(new hex_structures_Size(point.x,point.y));
	}
	,getFullLine: function() {
		return this._get(tictactoe_module_board_controller_IBoardController).getFullLine();
	}
	,getBoard: function() {
		return this._get(tictactoe_module_board_model_IBoardModel).getBoard();
	}
	,getSize: function() {
		return this._get(tictactoe_module_board_model_IBoardModel).getSize();
	}
	,getFreeCellCount: function() {
		return this._get(tictactoe_module_board_model_IBoardModel).getFreeCellCount();
	}
	,_getRuntimeDependencies: function() {
		return new hex_module_dependency_RuntimeDependencies();
	}
	,__class__: tictactoe_module_board_BoardModule
});
var tictactoe_module_board__$BoardModule_BoardModuleConfig = function() {
	hex_config_stateless_StatelessModuleConfig.call(this);
};
$hxClasses["tictactoe.module.board._BoardModule.BoardModuleConfig"] = tictactoe_module_board__$BoardModule_BoardModuleConfig;
tictactoe_module_board__$BoardModule_BoardModuleConfig.__name__ = ["tictactoe","module","board","_BoardModule","BoardModuleConfig"];
tictactoe_module_board__$BoardModule_BoardModuleConfig.__super__ = hex_config_stateless_StatelessModuleConfig;
tictactoe_module_board__$BoardModule_BoardModuleConfig.prototype = $extend(hex_config_stateless_StatelessModuleConfig.prototype,{
	configure: function() {
		this.mapModel(tictactoe_module_board_model_IBoardModel,tictactoe_module_board_model_BoardModel);
		this.mapController(tictactoe_module_board_controller_IBoardController,tictactoe_module_board_controller_BoardController);
	}
	,__class__: tictactoe_module_board__$BoardModule_BoardModuleConfig
});
var tictactoe_module_board_controller_IBoardController = function() { };
$hxClasses["tictactoe.module.board.controller.IBoardController"] = tictactoe_module_board_controller_IBoardController;
tictactoe_module_board_controller_IBoardController.__name__ = ["tictactoe","module","board","controller","IBoardController"];
...
tictactoe_module_board_controller_BoardController.__interfaces__ = [tictactoe_module_board_controller_IBoardController];
tictactoe_module_board_controller_BoardController.prototype = {
	setBoard: function(size,successLineCount) {
		this.model.initBoard(size,successLineCount);
	}
	,setBoardPoint: function(point,sign) {
		this.model.setBoardPoint({ x : point.width | 0, y : point.height | 0},sign);
	}
	,getBoardPoint: function(point) {
		return this.model.getBoardPoint({ x : point.width | 0, y : point.height | 0});
	}
	,getFullLine: function() {
...
$hxClasses["tictactoe.module.board.model.BoardModel"] = tictactoe_module_board_model_BoardModel;
tictactoe_module_board_model_BoardModel.__name__ = ["tictactoe","module","board","model","BoardModel"];
tictactoe_module_board_model_BoardModel.__interfaces__ = [tictactoe_module_board_model_IBoardModel];
tictactoe_module_board_model_BoardModel.__super__ = hex_model_BasicModel_$tictactoe_$module_$board_$model_$_$BoardModel_$BoardModelDispatcher_$tictactoe_$module_$board_$model_$IBoardModelListener;
tictactoe_module_board_model_BoardModel.prototype = $extend(hex_model_BasicModel_$tictactoe_$module_$board_$model_$_$BoardModel_$BoardModelDispatcher_$tictactoe_$module_$board_$model_$IBoardModelListener.prototype,{
	...
	,__class__: tictactoe_module_board_model_BoardModel
});
var tictactoe_module_board_model__$BoardModel_BoardModelDispatcher = function() {
	hex_model_ModelDispatcher.call(this);
};
$hxClasses["tictactoe.module.board.model._BoardModel.BoardModelDispatcher"] = tictactoe_module_board_model__$BoardModel_BoardModelDispatcher;
tictactoe_module_board_model__$BoardModel_BoardModelDispatcher.__name__ = ["tictactoe","module","board","model","_BoardModel","BoardModelDispatcher"];
tictactoe_module_board_model__$BoardModel_BoardModelDispatcher.__interfaces__ = [tictactoe_module_board_model_IBoardModelListener];
tictactoe_module_board_model__$BoardModel_BoardModelDispatcher.__super__ = hex_model_ModelDispatcher;
tictactoe_module_board_model__$BoardModel_BoardModelDispatcher.prototype = $extend(hex_model_ModelDispatcher.prototype,{
	onBoardInit: function(size) {
		var _g = 0;
		var _g1 = this._listeners;
		while(_g < _g1.length) {
	...
	,__class__: tictactoe_module_board_model__$BoardModel_BoardModelDispatcher
});
var tictactoe_module_game_GameModule = function(board,activePlayerIndicatorView,player1,player2,player3,player4,player5) {
	hex_module_Module.call(this);
	this._injector.mapToValue(tictactoe_api_IBoard,board);
	this._addStatelessConfigClasses([tictactoe_module_game__$GameModule_GameModuleConfig]);
	if(activePlayerIndicatorView != null) this._injector.injectInto(activePlayerIndicatorView);
	...
	this._get(tictactoe_module_game_controller_IGameController).setPlayerList(playerList);
};
...
var tictactoe_module_player_ai_AIPlayerModule = function(sign,board) {
	hex_module_Module.call(this);
	this._injector.mapToValue(tictactoe_api_IBoard,board);
	this._addStatelessConfigClasses([tictactoe_module_player_ai__$AIPlayerModule_AIPlayerModuleConfig]);
	this._get(tictactoe_module_player_ai_controller_IAIPlayerController).setPlayerSign(sign);
};
$hxClasses["tictactoe.module.player.ai.AIPlayerModule"] = tictactoe_module_player_ai_AIPlayerModule;
tictactoe_module_player_ai_AIPlayerModule.__name__ = ["tictactoe","module","player","ai","AIPlayerModule"];
tictactoe_module_player_ai_AIPlayerModule.__interfaces__ = [tictactoe_api_IPlayer];
tictactoe_module_player_ai_AIPlayerModule.__super__ = hex_module_Module;
tictactoe_module_player_ai_AIPlayerModule.prototype = $extend(hex_module_Module.prototype,{
	_getRuntimeDependencies: function() {
		return new hex_module_dependency_RuntimeDependencies();
	}
	,setPlayerTurn: function() {
		return this._get(tictactoe_module_player_ai_controller_IAIPlayerController).setPlayerTurn();
	}
	,getSign: function() {
		return this._get(tictactoe_module_player_ai_model_IAIPlayerModel).getPlayerSign();
	}
	,__class__: tictactoe_module_player_ai_AIPlayerModule
});
var tictactoe_module_player_ai__$AIPlayerModule_AIPlayerModuleConfig = function() {
	hex_config_stateless_StatelessModuleConfig.call(this);
};
$hxClasses["tictactoe.module.player.ai._AIPlayerModule.AIPlayerModuleConfig"] = tictactoe_module_player_ai__$AIPlayerModule_AIPlayerModuleConfig;
tictactoe_module_player_ai__$AIPlayerModule_AIPlayerModuleConfig.__name__ = ["tictactoe","module","player","ai","_AIPlayerModule","AIPlayerModuleConfig"];
tictactoe_module_player_ai__$AIPlayerModule_AIPlayerModuleConfig.__super__ = hex_config_stateless_StatelessModuleConfig;
tictactoe_module_player_ai__$AIPlayerModule_AIPlayerModuleConfig.prototype = $extend(hex_config_stateless_StatelessModuleConfig.prototype,{
	configure: function() {
		this.mapModel(tictactoe_module_player_ai_model_IAIPlayerModel,tictactoe_module_player_ai_model_AIPlayerModel);
		this.mapController(tictactoe_module_player_ai_controller_IAIPlayerController,tictactoe_module_player_ai_controller_AIPlayerController);
	}
	,__class__: tictactoe_module_player_ai__$AIPlayerModule_AIPlayerModuleConfig
});
var tictactoe_module_player_ai_controller_IAIPlayerController = function() { };
$hxClasses["tictactoe.module.player.ai.controller.IAIPlayerController"] = tictactoe_module_player_ai_controller_IAIPlayerController;
tictactoe_module_player_ai_controller_IAIPlayerController.__name__ = ["tictactoe","module","player","ai","controller","IAIPlayerController"];
...
tictactoe_module_player_ai_controller_AIPlayerController.__interfaces__ = [tictactoe_module_player_ai_controller_IAIPlayerController];
tictactoe_module_player_ai_controller_AIPlayerController.prototype = {
	setPlayerSign: function(sign) {
		this.model.setPlayerSign(sign);
	}
	,setPlayerTurn: function() {
		this.model.setPlayerTurn();
		this.playerTurnResponder = new hex_control_AsyncResponder();
		haxe_Timer.delay($bind(this,this.aiChoose),10);
	...
	,minimax: function(board,depth,isMax) {
		var line = tictactoe_util_BoardEvaluator.getFullLine(board);
		var score;
		if(line == null) score = 0; else if(line.sign == this.model.getPlayerSign()) score = 10; else score = -10;
		if(score != 0) return score;
		if((function($this) {
			var $r;
			var a = board.getFreeCellCount();
			$r = a == 0;
			return $r;
		}(this))) return 0;
		var width = board.size.width | 0;
		...
		if(isMax) {
			...
			while(_g < height) {
				...
				while(_g1 < width) {
					...
					if(board.board[i][j] == null) {
						board.board[i][j] = this.model.getPlayerSign();
						best = Std["int"](Math.max(best,this.minimax(board,depth + 1,!isMax)));
						board.board[i][j] = null;
					}
				}
			}
			...
			while(_g2 < height) {
				...
				while(_g11 < width) {
					var j1 = _g11++;
					if(board.board[i1][j1] == null) {
						board.board[i1][j1] = this.getOpositeSign();
						best1 = Std["int"](Math.min(best1,this.minimax(board,depth + 1,!isMax)));
						board.board[i1][j1] = null;
					}
				}
			}
			return best1;
...
var tictactoe_module_player_ai_model_AIPlayerModel = function() {
	this._active = false;
	hex_model_BasicModel_$tictactoe_$module_$player_$ai_$model_$_$AIPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$ai_$model_$IAIPlayerModelListener.call(this);
};
$hxClasses["tictactoe.module.player.ai.model.AIPlayerModel"] = tictactoe_module_player_ai_model_AIPlayerModel;
tictactoe_module_player_ai_model_AIPlayerModel.__name__ = ["tictactoe","module","player","ai","model","AIPlayerModel"];
tictactoe_module_player_ai_model_AIPlayerModel.__interfaces__ = [tictactoe_module_player_ai_model_IAIPlayerModel];
tictactoe_module_player_ai_model_AIPlayerModel.__super__ = hex_model_BasicModel_$tictactoe_$module_$player_$ai_$model_$_$AIPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$ai_$model_$IAIPlayerModelListener;
tictactoe_module_player_ai_model_AIPlayerModel.prototype = $extend(hex_model_BasicModel_$tictactoe_$module_$player_$ai_$model_$_$AIPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$ai_$model_$IAIPlayerModelListener.prototype,{
	setPlayerSign: function(playerSign) {
		this.playerSign = playerSign;
		this.dispatcher.onPlayerSignUpdate(playerSign);
	}
	,getPlayerSign: function() {
	...
	,__class__: tictactoe_module_player_ai_model_AIPlayerModel
});
var tictactoe_module_player_ai_model_IAIPlayerModelListener = function() { };
$hxClasses["tictactoe.module.player.ai.model.IAIPlayerModelListener"] = tictactoe_module_player_ai_model_IAIPlayerModelListener;
tictactoe_module_player_ai_model_IAIPlayerModelListener.__name__ = ["tictactoe","module","player","ai","model","IAIPlayerModelListener"];
tictactoe_module_player_ai_model_IAIPlayerModelListener.prototype = {
	__class__: tictactoe_module_player_ai_model_IAIPlayerModelListener
};
var tictactoe_module_player_ai_model__$AIPlayerModel_GameModelDispatcher = function() {
	hex_model_ModelDispatcher.call(this);
};
$hxClasses["tictactoe.module.player.ai.model._AIPlayerModel.GameModelDispatcher"] = tictactoe_module_player_ai_model__$AIPlayerModel_GameModelDispatcher;
tictactoe_module_player_ai_model__$AIPlayerModel_GameModelDispatcher.__name__ = ["tictactoe","module","player","ai","model","_AIPlayerModel","GameModelDispatcher"];
tictactoe_module_player_ai_model__$AIPlayerModel_GameModelDispatcher.__interfaces__ = [tictactoe_module_player_ai_model_IAIPlayerModelListener];
tictactoe_module_player_ai_model__$AIPlayerModel_GameModelDispatcher.__super__ = hex_model_ModelDispatcher;
tictactoe_module_player_ai_model__$AIPlayerModel_GameModelDispatcher.prototype = $extend(hex_model_ModelDispatcher.prototype,{
	onPlayerSignUpdate: function(sign) {
		var _g = 0;
		var _g1 = this._listeners;
		while(_g < _g1.length) {
			var listener = _g1[_g];
			++_g;
			listener.onPlayerSignUpdate(sign);
		}
	}
	...
	,__class__: tictactoe_module_player_ai_model__$AIPlayerModel_GameModelDispatcher
});
var tictactoe_module_player_user_UserPlayerModule = function(view,sign,board) {
	hex_module_Module.call(this);
	this._injector.mapToValue(tictactoe_api_IBoard,board);
	this._injector.mapToValue(tictactoe_module_player_user_view_IUserPlayerView,view);
	this._addStatelessConfigClasses([tictactoe_module_player_user__$UserPlayerModule_UserPlayerModuleConfig]);
	this._get(tictactoe_module_player_user_controller_IUserPlayerController).setPlayerSign(sign);
};
$hxClasses["tictactoe.module.player.user.UserPlayerModule"] = tictactoe_module_player_user_UserPlayerModule;
tictactoe_module_player_user_UserPlayerModule.__name__ = ["tictactoe","module","player","user","UserPlayerModule"];
tictactoe_module_player_user_UserPlayerModule.__interfaces__ = [tictactoe_api_IPlayer];
tictactoe_module_player_user_UserPlayerModule.__super__ = hex_module_Module;
tictactoe_module_player_user_UserPlayerModule.prototype = $extend(hex_module_Module.prototype,{
	_getRuntimeDependencies: function() {
		return new hex_module_dependency_RuntimeDependencies();
	}
	,setPlayerTurn: function() {
		return this._get(tictactoe_module_player_user_controller_IUserPlayerController).setPlayerTurn();
	}
	,getSign: function() {
		return this._get(tictactoe_module_player_user_model_IUserPlayerModel).getPlayerSign();
	}
	,__class__: tictactoe_module_player_user_UserPlayerModule
});
var tictactoe_module_player_user__$UserPlayerModule_UserPlayerModuleConfig = function() {
	hex_config_stateless_StatelessModuleConfig.call(this);
};
$hxClasses["tictactoe.module.player.user._UserPlayerModule.UserPlayerModuleConfig"] = tictactoe_module_player_user__$UserPlayerModule_UserPlayerModuleConfig;
tictactoe_module_player_user__$UserPlayerModule_UserPlayerModuleConfig.__name__ = ["tictactoe","module","player","user","_UserPlayerModule","UserPlayerModuleConfig"];
tictactoe_module_player_user__$UserPlayerModule_UserPlayerModuleConfig.__super__ = hex_config_stateless_StatelessModuleConfig;
tictactoe_module_player_user__$UserPlayerModule_UserPlayerModuleConfig.prototype = $extend(hex_config_stateless_StatelessModuleConfig.prototype,{
	configure: function() {
		this.mapModel(tictactoe_module_player_user_model_IUserPlayerModel,tictactoe_module_player_user_model_UserPlayerModel);
		this.mapController(tictactoe_module_player_user_controller_IUserPlayerController,tictactoe_module_player_user_controller_UserPlayerController);
	}
	,__class__: tictactoe_module_player_user__$UserPlayerModule_UserPlayerModuleConfig
});
var tictactoe_module_player_user_controller_IUserPlayerController = function() { };
$hxClasses["tictactoe.module.player.user.controller.IUserPlayerController"] = tictactoe_module_player_user_controller_IUserPlayerController;
tictactoe_module_player_user_controller_IUserPlayerController.__name__ = ["tictactoe","module","player","user","controller","IUserPlayerController"];
...
tictactoe_module_player_user_controller_UserPlayerController.__interfaces__ = [tictactoe_module_player_user_controller_IUserPlayerController];
tictactoe_module_player_user_controller_UserPlayerController.prototype = {
	setPlayerSign: function(sign) {
		this.model.setPlayerSign(sign);
	}
	,setPlayerTurn: function() {
		this.model.setPlayerTurn();
		this.playerTurnResponder = new hex_control_AsyncResponder();
		this.view.getChoice().onComplete($bind(this,this.onPlayerTurnResult));
		return this.playerTurnResponder;
	}
...
tictactoe_module_player_user_model_IUserPlayerModelListener.__name__ = ["tictactoe","module","player","user","model","IUserPlayerModelListener"];
tictactoe_module_player_user_model_IUserPlayerModelListener.prototype = {
	__class__: tictactoe_module_player_user_model_IUserPlayerModelListener
};
var tictactoe_module_player_user_model_UserPlayerModel = function() {
	this._active = false;
	hex_model_BasicModel_$tictactoe_$module_$player_$user_$model_$_$UserPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$user_$model_$IUserPlayerModelListener.call(this);
};
$hxClasses["tictactoe.module.player.user.model.UserPlayerModel"] = tictactoe_module_player_user_model_UserPlayerModel;
tictactoe_module_player_user_model_UserPlayerModel.__name__ = ["tictactoe","module","player","user","model","UserPlayerModel"];
tictactoe_module_player_user_model_UserPlayerModel.__interfaces__ = [tictactoe_module_player_user_model_IUserPlayerModel];
tictactoe_module_player_user_model_UserPlayerModel.__super__ = hex_model_BasicModel_$tictactoe_$module_$player_$user_$model_$_$UserPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$user_$model_$IUserPlayerModelListener;
tictactoe_module_player_user_model_UserPlayerModel.prototype = $extend(hex_model_BasicModel_$tictactoe_$module_$player_$user_$model_$_$UserPlayerModel_$GameModelDispatcher_$tictactoe_$module_$player_$user_$model_$IUserPlayerModelListener.prototype,{
	setPlayerSign: function(playerSign) {
		this.playerSign = playerSign;
		this.dispatcher.onPlayerSignUpdate(playerSign);
	}
	...
	,__class__: tictactoe_module_player_user_model_UserPlayerModel
});
var tictactoe_module_player_user_model__$UserPlayerModel_GameModelDispatcher = function() {
	hex_model_ModelDispatcher.call(this);
};
$hxClasses["tictactoe.module.player.user.model._UserPlayerModel.GameModelDispatcher"] = tictactoe_module_player_user_model__$UserPlayerModel_GameModelDispatcher;
tictactoe_module_player_user_model__$UserPlayerModel_GameModelDispatcher.__name__ = ["tictactoe","module","player","user","model","_UserPlayerModel","GameModelDispatcher"];
tictactoe_module_player_user_model__$UserPlayerModel_GameModelDispatcher.__interfaces__ = [tictactoe_module_player_user_model_IUserPlayerModelListener];
tictactoe_module_player_user_model__$UserPlayerModel_GameModelDispatcher.__super__ = hex_model_ModelDispatcher;
tictactoe_module_player_user_model__$UserPlayerModel_GameModelDispatcher.prototype = $extend(hex_model_ModelDispatcher.prototype,{
	onPlayerSignUpdate: function(sign) {
		var _g = 0;
		var _g1 = this._listeners;
		while(_g < _g1.length) {
	...
	,__class__: tictactoe_module_player_user_model__$UserPlayerModel_GameModelDispatcher
});
